...
A("| 3차 | **`template_animation_id=\"walking-6-frames\"`** — 방식을 바꿨다 | `88751c0f` | **수신 완료 · 사용자 판정 대기** — 네 방향 24프레임 · 256 · `Docs/art_log/candidates/robot_a_Move_v3/` |")
A("")
...
A("")
A("**총 소요 47분.** 도구 안내는 「2~4분」이었다. 방향당 1 생성이라 비용은 4 로 가장 쌌지만")
A("**시간이 가장 비쌌다** — v3 문안 넷이 24 생성에 6분이었던 것과 견주면 그렇다.")
A("템플릿을 다시 고를 때 알고 있어야 하는 값이다.")
A("")
A("### 3-4. 물러난 동작 묘사 (기록)")
A("")
