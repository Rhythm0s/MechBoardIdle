...
A("비용은 방향당 1 생성이다.")
A("")
A("⚠️ **3차가 순조롭지 않다** (2026-09-07 12시대 실측). 네 방향 중 **하나는 실패**했고, 나머지 셋은")
A("24분째 40~67% 에 ETA 가 900초로 줄지 않는다. 도구가 안내한 「2~4분」을 크게 넘겼다.")
A("**취소하지 않고 기다린다** — `download` 는 한 벌이라도 생성 중이면 잠겨 완료분만 먼저 꺼낼 수 없다.")
A("")
