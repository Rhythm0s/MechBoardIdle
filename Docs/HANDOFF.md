...
last_in:  260906_W02 (3d3e6132-cf18-81e3-b0df-d4755222a6c0) — 측정법 캔버스 확정 · 판정 여섯 · 설계 오류 둘
        + 260906_W03 (3d3e6132-cf18-8194-b43b-c24bd4bfd893) — 회피 스택 확정 넷 · W02와 묶어 한 장으로 답하라
        그 앞은 W01(3d3e6132-cf18-815f-850e-f92d6f4689ff)
last_out: 260906_V04  (작성 중 · 로컬 초안 scratchpad/260906_V04.md) — W02+W03 한 장
        그 앞은 V03(3d3e6132-cf18-81c9-ae2e-c72e96effd8a) · V02(3d3e6132-cf18-811b-8c93-e8d32b32c3ab) · V01(3d3e6132-cf18-81c8-a0cc-fbe54709125f)
...
재생성_셋: |
  ...
  node_booster c94bf68c — 여백 L4 R4 T7 B5 통과. 그런데 실루엣이 삼각이 아니라 모서리 자른 사각.
    21쌍 겹침 최대가 0.860 → 0.894(core×booster)로 올랐다. 판정 대기.
...
6: Play 육안 확인 대기 — 배치모드가 못 보는 자리 셋
   ...
   (b) 구역 점선·이름표가 규격대로 보이는지, 이름표 미색 40%가 글자로 너무 흐리지 않은지
