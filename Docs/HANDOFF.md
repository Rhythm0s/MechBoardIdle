...
last_in:  260905_W05  (인수인계 · 내일 시작 조건 · 회신문 규격 넷)
          260905_W04  (판정 다섯 · 15-1 넷 · 깨진 글자 위임) — W05와 함께 받았다
last_out: 260906_V01  (3d3e6132-cf18-81c8-a0cc-fbe54709125f) — W04·W05에 한 장으로 답함 (차례제)
...
- 연출 셋을 512로 올리지 말 것 (크기가 아니라 형태를 고친다)
```
