...
next_out: |
  **V04 는 W03 이 온 뒤에 낸다** — 회신 단위는 차례제다(지침 §10 「회신 왕래 규칙」 하나).
  V03 게시 뒤에 쌓인 것은 전부 V04 에 담는다. **재료 목록 = 플랜 wild-swimming-starlight.md §28-2**
  (합체 재승인 · F 자세 미변화 실측 · G 의 ⓑ 결과 셋 · 보고서 재실행 값 ·
   frame_008 사고 · 리포 공개 상태 · 아트 로그 차수 표기)
last_out: 260907_V03  (3d4e6132-cf18-81ca-9484-dde4e4959829) — **2026-09-07 게시 완료.**
