...
namespace MBI.UI
{
    ...
    public sealed class VariablePanel : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            // ⚠️ **전투 화면에는 안 그린다**(2026-09-11 사용자 육안 · 플랜 §71-16 ①).
            //
            // 이 패널은 **레이어 2**(조립 화면)의 띠 하나다. 그런데 화면을 안 가리고 있어서
            // **전투 화면 하단에 베이지 띠 하나가 남아 있었다** — 레이어 1 에는 없는 것이
            // 그려진 것이고, 사용자 눈에 「바탕이 새어 나온다」로 보였다.
            //
            // 전투 화면에 그리는 것은 **레이어 1 여섯**뿐이다(정보줄 · 상태창 · 방치 보상 ·
