namespace MBI.Data
{
    ...
    public enum NodeType
    {
        Core = 0,           // 코어
        Processing = 1,     // 가공
        MunitionsBasic = 2, // 기초 가공소 (2026-09-04 개명 — 구 Munitions. **정수 값을 보존한다**)
        Energy = 3,         // 에너지
        Storage = 4,        // 저장
        ...
        /// <summary>
        /// 복합 가공소 (2026-09-04 신설 · `260904_W01` 3장).
        ///
    ...
    public enum FlowKind
    {
        ...
        StandardAmmo,    // 표준탄 — 기초 가공소 산출이며 **특수탄의 재료**다 (구 표준탄 자리)
        DroneBodyParts,  // 드론 몸체 부품 — 기초 가공소 산출
        DefenseMaterial, // 방어 재료 — 기초 가공소 산출
        PierceAmmo,      // 관통탄 — 복합 가공소. 표준탄 + 기초재료·부품
        ExplosiveAmmo,   // 폭발탄 — 복합 가공소. 표준탄 + 발전재료
        StackDrone,      // 누적형 드론 — 복합 가공소. 배터리 + 드론 몸체 부품
        AoeDrone,        // 광역형 드론 — 복합 가공소. 배터리 + 드론 몸체 부품
    }
