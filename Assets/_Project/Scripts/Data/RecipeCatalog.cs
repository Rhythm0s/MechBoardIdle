...
namespace MBI.Data
{
    ...
    /// 기초·복합으로 갈렸다.
    ///
    /// ✅ **수량은 1 로 확정됐다** (2026-09-11 · `260911_W01` 2장 값 5).
    /// 레시피 표가 입력을 전부 「코어 에너지 1 · 부품 1 · 발전재료 1」로 적고 있어
    /// **문서와 이미 일치했다** — 바뀐 것은 값이 아니라 **표시**다.
    ///
    /// ⚠️ **구 이름 `PerOutputTbd` 는 폐기.** 값이 맞는데 「미정」으로 적혀 있으면
    /// **다음 사람이 또 미정으로 읽는다.**
    /// </summary>
    public static class RecipeCatalog
    {
        /// <summary>
        /// 산출 1개당 재료 개수 — **1 확정** (2026-09-11 · `260911_W01` 값 5).
        ///
        /// 행마다 값이 갈릴 자리는 남아 있다. 갈리는 날 이 상수 대신 행별 값을 넣는다.
        /// </summary>
        public const float PerOutput = 1f;
