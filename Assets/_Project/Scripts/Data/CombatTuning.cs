...
namespace MBI.Data
{
    ...
    public sealed class CombatTuning : ScriptableObject
    {
        ...
        [Tooltip("⚠️ 구현 가정 — 빔 수의 상한. 표적이 이보다 많으면 표적을 고르지 않고 한 바퀴를 고르게 나눈다.")]
        ...
        /// 📌 **비어 있으면 자리표시 고리**로 그린다(`droneAoeRingPlaceholder` 가 참일 때만).
        /// </summary>
        [Tooltip("광역형 드론 범위 타격(vfx_drone_aoe). 속이 빈 얇은 고리 · 아트가 온다.")]
        public Sprite droneAoeSprite;

        /// <summary>
        /// 그림이 오기 전 **자리표시 고리를 그릴 것인가** — 기본 **거짓(안 그린다)**.
        ///
        ...
        /// </summary>
        [Tooltip("광역형 범위 자리표시 고리를 그릴지. 기본 꺼짐 — 지금은 판정 반경이 사거리(9.2)라 화면을 크게 덮는다.")]
        public bool droneAoeRingPlaceholder;
