...
namespace MBI.EditorTools
{
    ...
    public static class AmmoCoordProbe
    {
        ...
        public static string Run()
        {
            ...
            // 표준 = 기초 가공소 + 부품 가공.
            // 관통 = 복합 가공소 + 표준탄 라인 둘 + 부품 가공.
            // 폭발 = 복합 가공소 + 표준탄 라인 둘 + 발전재료 가공.
        ...
        private static void Four(StringBuilder sb, Chain pierce, Chain expl)
        {
            ...
            sb.AppendLine($"  복합 가공소 전력이 0이었을 때 {withZero:F0}/초 → {EnergyLine(withZero)}");
