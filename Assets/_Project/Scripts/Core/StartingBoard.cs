...
namespace MBI.Core
{
    ...
    ///
    /// **왜 표준탄인가.** 관통탄은 복합 가공 소관이고 표준탄을 먹는다. 그걸로 시작 보드를
    /// 짜면 튜토리얼에서 복합 가공까지 가르쳐야 하는데, 스테이지의 학습 목표는
    /// 「벨트를 이으면 물건이 만들어진다」 하나다. **표준탄은 기초 가공만으로 완성되는
    /// 유일한 탄이라** 3단으로 끝난다.
    ///
    ...
    public static class StartingBoard
    {
        ...
        public struct Slot
        {
            ...
            ///
            /// ⚠️⚠️ **안 고르면 기본값으로 돈다.** 기초 가공의 기본은 **표준탄**이라,
        ...
        /// (2026-09-11 설계 확정 (가) · `260911_W02` · 구 「기초 군수 (7,8)」 폐기(그 노드의 지금 이름은 「기초 가공」)).
        ///
        ...
        /// <summary>
        /// 시작 노드. **동 줄의 기초 가공가 빠져 있다** — 그 자리가 비워 둔 칸이다.
        ///
        ...
        public static string Generation
        {
            get
            {
                ...
                //    기초 가공 = 추진제). 안 섞으면 조합표를 바꿔도 표식이 그대로여서
                //    바뀐 판 위에 옛 저장이 올라온다.
